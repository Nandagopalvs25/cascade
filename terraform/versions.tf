...
locals {
  ...
  md_stability_image = "${var.gpu_region}-docker.pkg.dev/${var.project_id}/${google_artifact_registry_repository.cascade_gpu.repository_id}/md-stability@${var.md_stability_image_digest}"
}
